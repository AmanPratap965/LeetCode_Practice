...
-- select v.customer_id,t.count(visit_id) as count_no_trans from Visits as v, tran
...
-- select count(visit_id) as count_no_trans from Transactions group by visit_id;